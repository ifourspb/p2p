...
<div class="header">
	...
	<div style="width:100%;height:250px;">
	    ...
	    <div style="width:48%;float:left;">
		    ...
		    <div style="margin-left: 50px;border-radius: 10px; margin-top: 10px; border: 3px solid #2266aa;border-style:dotted;height:230px;width:390px;">
			    ...
			    <div class="inside field card" style="margin-left:30px;margin-top:10px;">
					...
					<br />
			        <input oninput="getNumeration ()" onpropertychange="getNumeration ()" name="card_number" maxlength="19" required style="width:320px;height:25px;" placeholder="  0000 0000 0000 0000" id="check1" type="text" value="<?=$card_number?>">
	    ...
	    <div style="width:48%;float:left;">
		    ...
		    <div style="margin-left: 50px; margin-top: 10px; border-radius: 10px;border: 3px solid #2266aa;border-style:dotted;height:230px;width:390px;">
			     ...
			     <div class="inside field card" style="margin-left:30px;margin-top:75px;">
					...
					<br />
			        <input oninput="getNumeration2 ()" onpropertychange="getNumeration2 ()" name="card_number2" maxlength="19" required style="width:320px;height:32px;" placeholder="  0000 0000 0000 0000" id="check9" type="text" value="<?=$card_number2?>">
                     <br/>
	...
	<div style="width:100%; height: 153px; margin-bottom: 15px; border: 2px solid #D6D6D6;">
